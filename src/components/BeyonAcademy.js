                    ...
                    <div className="flex flex-wrap -m-4">
                        <div className="xl:w-1/4 md:w-1/2 p-4">
                            ...
                            <div className="flex mt-[64px]  justify-center ">
                                <button className=" text-white bg-[#FFA700] border-0 py-2 px-6 focus:outline-none hover:bg-purple-600 rounded text-lg">Read More</button>
                        ...
                        <div className="xl:w-1/4 md:w-1/2 p-4">
                            ...
                            <h1 className='text-center text-white my-5'>mcgsmun</h1>
