                    ...
                    <div className="flex flex-wrap -m-4">
                        <div className="xl:w-1/4 md:w-1/2 p-6 md:p-4">
                            <div className="bg-gray-100 p-6 rounded-2xl h-[33em] box__shadow ">
                                ...
                                <div className=' text-center my-10'>
                                    <button type="submit" className="text-white bg-[#FFA700]  focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded text-sm w-full sm:w-auto px-10 py-2.5 text-center ">Submit</button>
                                </div>
                            </div>
                        </div>
                        <div className="xl:w-1/4 md:w-1/2 p-6 md:p-4">
                        ...
                        <div className="xl:w-1/4 md:w-1/2 p-6 md:p-4 w-full">
                            <div className="bg-gray-100 p-6 rounded-2xl box__shadow">
                                ...
                                <h1 className=' text-center font-bold text-[#990000]'>APPLY FOR
                                    ADMISSIONS</h1>
                                ...
                                <div className='my-[109px]'>
                                    <form>
                                        ...
                                        <div className=' text-center '>
                                            <button type="submit" className="text-white bg-[#FFA700] hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded text-sm w-full sm:w-auto px-10 py-2.5 text-center ">Submit</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
